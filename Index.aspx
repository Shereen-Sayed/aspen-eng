            ...
            <div class="row">
              <div class="col-lg-12">
                <ul id="portfolio-flters">
                  <li data-filter="*" class="filter-active">Water Projects</li>
                  <li data-filter=".filter-app">Engineering Work Samples</li>
                  <li data-filter=".filter-card">Contracts Work Samples</li>
                  <li data-filter=".filter-web">Miscellaneous SILO Projects</li>
                </ul>
              </div>
            </div>
            ...
            <div class="row portfolio-container">
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                <div class="portfolio-wrap">
                  <figure>
                    <img src="img/portfolio/Water_Projects.jpg" class="img-fluid" alt=""/>
                    <a href="img/portfolio/Water_Projects.jpg" data-lightbox="portfolio" data-title="Water_Projects" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>
                    <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                  </figure>

                  <div class="portfolio-info">
                    <h4><a href="#">Water Projects</a></h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                <div class="portfolio-wrap">
                  <figure>
                    <img src="img/portfolio/Grain_Cement.jpg" class="img-fluid" alt=""/>
                    <a href="img/portfolio/Grain_Cement.jpg" class="link-preview" data-lightbox="portfolio" data-title="Grain_Cement" title="Preview"><i class="ion ion-eye"></i></a>
                    <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                  </figure>

                  <div class="portfolio-info">
                    <h4><a href="#">Grain, and Cement plants</a></h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                <div class="portfolio-wrap">
                  <figure>
                    <img src="img/portfolio/Buildings_2.jpg" class="img-fluid" alt=""/>
                    <a href="img/portfolio/Buildings_2.jpg" class="link-preview" data-lightbox="portfolio" data-title="Buildings" title="Preview"><i class="ion ion-eye"></i></a>
                    <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                  </figure>

                  <div class="portfolio-info">
                    <h4><a href="#">Buildings</a></h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                <div class="portfolio-wrap">
                  <figure>
                    <img src="img/portfolio/Industrial_Projects.jpg" class="img-fluid" alt=""/>
                    <a href="img/portfolio/Industrial_Projects.jpg" class="link-preview" data-lightbox="portfolio" data-title="Industrial_Projects" title="Preview"><i class="ion ion-eye"></i></a>
                    <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                  </figure>

                  <div class="portfolio-info">
                    <h4><a href="#">Industrial Projects</a></h4>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                <div class="portfolio-wrap">
                  ...
                  <div class="portfolio-info">
                    <h4><a href="#">Miscellaneous Projects</a></h4>
                  </div>
                </div>
              </div>
